...
class AttributesValueCacheBehavior extends Behavior implements BehaviorInterface
{
    /**
     * @param $eventType
     * @param $model
    ...
    public function notify($eventType, \Phalcon\Mvc\ModelInterface $model)
    {
        switch ($eventType) {
            ...
            case 'afterCreate':
                ...
                $this->emptyCache(CacheHelper::__getCacheNameAttributeValue($model->getId() , $model->getCompanyId()));
                break;
            default:
