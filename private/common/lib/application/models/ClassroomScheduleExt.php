...
class ClassroomScheduleExt extends ClassroomSchedule
{
    use ModelTraits;
    ...
    public function initialize()
    {
        ...
        $this->belongsTo('classroom_id', '\SMXD\Application\Models\ClassroomExt', 'id', [
            'alias' => 'Classroom'
        ]);
    }
     ...
     * @return array|ClassroomScheduleExt|ClassroomSchedule
     */
