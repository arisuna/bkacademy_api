...
class StudentScoreExt extends StudentScore
{
    ...
    public function __save()
    {
        ...
        $model->setIsMainScore(isset($data['is_main_score']) ? $data['is_main_score'] : $model->getIsMainScore());
        $model->setScore(isset($data['score']) ? $data['score'] : $model->getScore());
        $model->setCorrect(isset($data['correct']) ? $data['correct'] : $model->getCorrect());
        $model->setWrong(isset($data['wrong']) ? $data['wrong'] : $model->getWrong());
        $model->setNotDone(isset($data['not_done']) ? $data['not_done'] : $model->getNotDone());
    ...
    public function toArray($columns = NULL)
    {
        ...
        $array['correct'] = intval($array['correct']);
        $array['wrong'] = intval($array['wrong']);
        $array['not_done'] = intval($array['not_done']);
        $array['is_main_score'] = intval($array['is_main_score']);
        return $array;
    }
