...
class CommunicationTopicFlag extends \Reloday\Application\Models\CommunicationTopicFlagExt
{	
    ...
    public static function findTopicUser($topic_id, $user_profile_id)
    {
        return self::findFirst([
            'conditions' => 'communication_topic_id = :topic_id: AND user_profile_id = :user_profile_id:',
            'bind' => [
                'topic_id' => $topic_id,
