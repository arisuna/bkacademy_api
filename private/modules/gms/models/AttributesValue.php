...
class AttributesValue extends \Reloday\Application\Models\AttributesValueExt
{
	...
	public function initialize(){
		parent::initialize();
		$this->hasMany('id', '\Reloday\Gms\Models\AttributesValueTranslation', 'attributes_value_id', array('alias' => 'translation'));
	}
}
