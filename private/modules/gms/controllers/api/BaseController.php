...
use Reloday\Application\Aws\AwsCognito\AwsCognitoResult;
...
class BaseController extends ModuleApiController
{
    ...
    {
        // Check user in group
        if (!is_object(ModuleModel::$user_profile) || empty(ModuleModel::$user_profile) || !method_exists(ModuleModel::$user_profile, 'getUserGroupId')) {
            return [
                'success' => false,
