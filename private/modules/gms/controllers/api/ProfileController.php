...
use Reloday\Gms\Models\UserInterfaceVersion;
...
use Reloday\Gms\Models\UserSettingGroup;
...
class ProfileController extends BaseController
{
    ...
    public function indexAction()
    {
        ...
        $profile_array = ModuleModel::$user_profile->getParsedArray();
        $profile_array['versions'] = ModuleModel::$user_profile->getUiVersionList();
        $login = ModuleModel::$user_profile->getUserLogin();
        $result = [
            'success' => true,
    ...
    public function getSettingListAction()
    {
        $this->view->disable();
        $this->checkAjax('GET');
        $settings = ModuleModel::$user_profile->getUserSetting();
    ...
    public function getSettingVariablesAction()
    {
        $this->view->disable();
        $this->checkAjax('GET');
        $settingAppList = ModuleModel::$user_profile->getUserSetting();
        $variables = [];
    ...
    public function getLoginInfoAction()
    {
        ...
        $model = ModuleModel::$user_profile;
