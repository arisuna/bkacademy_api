...
class User extends \SMXD\Application\Models\UserExt
{
    ...
    public function initialize()
    {
        ...
        $this->belongsTo('user_group_id', 'SMXD\Api\Models\StaffUserGroup', 'id', [
            'alias' => 'UserGroup'
        ]);
        $this->belongsTo('company_id', 'SMXD\Api\Models\Company', 'id', [
            'alias' => 'Company'
        ]);
        $this->belongsTo('country_id', 'SMXD\Api\Models\Country', 'id', [
            'alias' => 'Country'
        ]);
    }
    ...
    public static function __findWithFilters($options, $orders = [])
    {
        ...
        $queryBuilder->addFrom('\SMXD\Api\Models\User', 'User');
        $queryBuilder->distinct(true);
        $queryBuilder->leftJoin('\SMXD\Api\Models\StaffUserGroup', "UserGroup.id = User.user_group_id", 'UserGroup');
