...
class Constant extends \SMXD\Application\Models\ConstantExt
{
    ...
    public function initialize()
    {
        ...
        $this->hasMany('id', 'SMXD\Api\Models\ConstantTranslation', 'constant_id', [
    ...
    public static function __findWithFilters($options)
    {
        ...
        $queryBuilder->addFrom('\SMXD\Api\Models\Constant', 'Constant');
        $queryBuilder->distinct(true);
        $queryBuilder->leftJoin('\SMXD\Api\Models\ConstantTranslation', "Constant.id = ConstantTranslationVI.constant_id AND ConstantTranslationVI.language = 'vi'", 'ConstantTranslationVI');
        $queryBuilder->leftJoin('\SMXD\Api\Models\ConstantTranslation', "Constant.id = ConstantTranslationEN.constant_id AND ConstantTranslationEN.language = 'en'", 'ConstantTranslationEN');
