...
{	
	...
	public function initialize(){
        ...
        $this->belongsTo('attribute_id', '\SMXD\Api\Models\Attributes', 'id', [
            'alias' => 'Attribute'
        ]);
	}
    ...
    public static function __findWithFilters($options)
    {
        ...
        $queryBuilder->addFrom('\SMXD\Api\Models\ProductField', 'ProductField');
        $queryBuilder->leftJoin('\SMXD\Api\Models\Attributes', 'ProductField.attribute_id = Attribute.id', 'Attribute');
