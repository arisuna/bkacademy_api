...
use SMXD\Backend\Models\Company;
 ...
 * @RoutePrefix("/gms/api")
 */
class BackendUploaderController extends BaseController
{
    /**
    ...
    */
    ...
    public function attachAction()
    {
        ...
        $this->view->disable();
        $return = ['success' => false, 'msg' => 'UPLOAD_FAIL_TEXT'];
    ...
    public function listAction($uuid = '')
    {
        ...
        $return = ['success' => false, 'msg' => 'DATA_NOT_FOUND_TEXT'];
    ...
    protected function isLogged()
    {
        ...
        $token_key = isset($header['Backend-Token']) ? $header['Backend-Token'] : (isset($header['backend-token']) ? $header['backend-token'] : '');

        try {
            $jwt = JWT::decode($token_key, getenv('JWT_KEY'), array(getenv('JWT_ALG')));
            if ($jwt->data->username == 'admin') {
                return ['success' => true, 'msg' => 'Login success'];
            } else {
                return ['success' => false, 'msg' => $token_key];
            }
        } catch (\Exception $e) {
